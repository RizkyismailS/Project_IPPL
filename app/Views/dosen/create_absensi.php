...
<section class="section">
    <div class="card">
        <div class="card-body">
            <form action="<?= base_url('dosen/sesi-absensi/store'); ?>" method="post">
                <?= csrf_field(); ?>
                <input type="hidden" name="kode_kelas" value="<?= esc($kelas['kode_kelas']); ?>">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control <?= ($validation->hasError('topik_perkuliahan')) ? 'is-invalid' : ''; ?>" id="topik_perkuliahan" name="topik_perkuliahan" rows="3" required><?= old('topik_perkuliahan'); ?></textarea>
                         ...
                         <div class="mb-3">
                            ...
                            <select class="form-select <?= ($validation->hasError('perlu_bukti_foto')) ? 'is-invalid' : ''; ?>" name="perlu_bukti_foto" id="perlu_bukti_foto">
                                <option value="1" <?= old('perlu_bukti_foto') == '1' ? 'selected' : '' ?>>Ya</option>
                                <option value="0" <?= old('perlu_bukti_foto') == '0' ? 'selected' : '' ?>>Tidak</option>
                            </select>
                    ...
                    <div class="col-md-6">
                         <div class="mb-3">
                            ...
                            <input type="date" class="form-control <?= ($validation->hasError('tanggal_sesi')) ? 'is-invalid' : ''; ?>" id="tanggal_sesi" name="tanggal_sesi" value="<?= old('tanggal_sesi'); ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" class="form-control <?= ($validation->hasError('waktu_mulai_aktual')) ? 'is-invalid' : ''; ?>" id="waktu_mulai_aktual" name="waktu_mulai_aktual" value="<?= old('waktu_mulai_aktual'); ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" class="form-control <?= ($validation->hasError('waktu_selesai_aktual')) ? 'is-invalid' : ''; ?>" id="waktu_selesai_aktual" name="waktu_selesai_aktual" value="<?= old('waktu_selesai_aktual'); ?>" required>
