                ...
                <div class="card-body">
                    <form action="<?= base_url('Absensi/simpan') ?>" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_Absensi" name="nama_Absensi" required>
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="text-center mt-4">
                            <button type="submit" class="btn btn-success px-4 py-2">Buat Absensi</button>
                        </div>
                    </form>
                </div>
            </div>
