    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= base_url('dosen/profile/update') ?>" method="post">
                        <?= csrf_field() ?>
                        
                        <div class="mb-3">
                            <label for="nip" class="form-label">NIP</label>
                            <input type="text" class="form-control" id="nip" name="nip" value="<?= esc($dosen['nip']) ?>" readonly>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?= (isset($validation) && $validation->hasError('jabatan')) ? 'is-invalid' : '' ?>" 
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php if (isset($user) && $user) : ?>
                        ...
                        <hr>
                        <h5>Ubah Password</h5>
                        <form action="<?= base_url('dosen/profile/change-password') ?>" method="post">
                            <?= csrf_field() ?>
