    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
                <input type="text" class="form-control w-50" placeholder="Cari Mahasiswa">
                <select class="form-select w-auto ms-2">
                    <option>All status</option>
                    <option>Active</option>
                    <option>Inactive</option>
                </select>
                <a href="#" class="btn btn-primary ms-auto"><i class="bi bi-plus-lg"></i> Tambah Mahasiswa Baru</a>
            </div>
